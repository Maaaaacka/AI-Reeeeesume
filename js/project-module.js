(function() {
  const ProjectEditor = {
      ...
      <div class="project-editor">
        ...
        <div v-for="(proj, idx) in projects" :key="idx" class="project-item">
          <div style="display: flex; gap: 12px; align-items: flex-start;">
            ...
            <button class="btn-icon" @click="removeProject(idx)">
    ...
    methods: {
      addProject() { this.projects.push({ name: '', url: '', description: '' }); },
      removeProject(index) { this.projects.splice(index, 1); }
    }
  };
  if (typeof window !== 'undefined') window.ProjectEditor = ProjectEditor;
})();
